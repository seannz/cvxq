...
from transformers.models.modeling_attn_mask_utils import _prepare_4d_causal_attention_mask
...
from transformers.models.utils import (
...
class OPTDecoder(OPTPreTrainedModel):
    ...
    def forward(
        ...
        for idx, decoder_layer in enumerate(self.layers):
            ...
            if self.gradient_checkpointing: # and self.training: # enable checkpoint even when evaluating
